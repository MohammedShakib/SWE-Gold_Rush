                    ...
                    <div className="p-6 flex-1 flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full bg-[#0B0D10] border border-white/10 rounded-lg p-3 text-white text-sm focus:outline-none focus:border-primary-gold"
                            >
                    ...
                    <div className="relative bg-[#1E2024] p-8 rounded-2xl border border-white/10 w-full max-w-lg shadow-2xl animate-fade-in-up scale-100 z-10 m-4">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input type="text" name="name" required value={newCustomer.name} onChange={handleInputChange} className="w-full bg-[#121418] border border-white/10 rounded-lg p-2.5 text-white focus:outline-none focus:border-primary-gold transition-colors" />
                            </div>
                            <div>
                                <label className="text-xs text-gray-400 uppercase font-bold block mb-1.5">Phone Number</label>
                                <input type="text" name="phone" value={newCustomer.phone} onChange={handleInputChange} className="w-full bg-[#121418] border border-white/10 rounded-lg p-2.5 text-white focus:outline-none focus:border-primary-gold transition-colors" />
                            </div>

                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="text-xs text-gray-400 uppercase font-bold block mb-1.5">Type</label>
                                    <select name="type" value={newCustomer.type} onChange={handleInputChange} className="w-full bg-[#121418] border border-white/10 rounded-lg p-2.5 text-white focus:outline-none focus:border-primary-gold transition-colors">
                                ...
                                <div>
                                    <label className="text-xs text-gray-400 uppercase font-bold block mb-1.5">Total Spent</label>
                                    <input type="number" name="total_spent" value={newCustomer.total_spent} onChange={handleInputChange} className="w-full bg-[#121418] border border-white/10 rounded-lg p-2.5 text-white focus:outline-none focus:border-primary-gold transition-colors" />
                                </div>
                            </div>

                            <div>
                                <label className="text-xs text-gray-400 uppercase font-bold block mb-1.5">Last Visit</label>
                                <input type="date" name="last_visit" value={newCustomer.last_visit} onChange={handleInputChange} className="w-full bg-[#121418] border border-white/10 rounded-lg p-2.5 text-white focus:outline-none focus:border-primary-gold transition-colors" />
                            </div>
                            ...
                            <div className="flex justify-end gap-3 mt-8">
                                ...
                                <button type="submit" className="bg-primary-gold text-black px-6 py-2.5 rounded-xl font-bold hover:bg-yellow-400 transition-colors shadow-lg shadow-primary-gold/20">Add Customer</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center">
                    ...
                    <div className="relative bg-[#1E2024] p-8 rounded-2xl border border-white/10 w-full max-w-lg shadow-2xl animate-fade-in-up scale-100 z-10 m-4">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button onClick={() => setSelectedCustomer(null)} className="text-gray-400 hover:text-white transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                                </svg>
                            </button>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-8">
                            <div className="bg-[#121418] p-4 rounded-xl border border-white/5 text-center">
