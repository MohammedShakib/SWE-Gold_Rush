...
const SignIn = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050608] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-[420px] relative z-10 perspective-1000 px-4">
                ...
                <div className="bg-[#121418]/70 backdrop-blur-2xl border border-white/5 rounded-[2rem] p-6 md:p-10 shadow-2xl shadow-black/50 relative overflow-hidden group hover:border-primary-gold/20 transition-all duration-500">
                    {/* Card Shine Effect */}
                    ...
                    <div className="text-center mb-8 md:mb-10 relative z-10">
                        <h2 className="text-2xl md:text-3xl font-bold text-white mb-3 tracking-tight">{t.title}</h2>
